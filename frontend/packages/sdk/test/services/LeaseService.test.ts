...
import { MasterKeyService, MasterKeys } from '../../src/crypto/MasterKeyService';
...
describe('LeaseService', () => {
  ...
  it('should re-encrypt a secret for an agent', async () => {
    // 1. Create a secret
    ...
    const agentPubKeyB64 = await CryptoService.exportPublicKey(agentKeyPair.publicKey);
