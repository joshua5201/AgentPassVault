...
export class AuthControllerApi extends runtime.BaseAPI {
   ...
   */
  async agentLoginRaw(
    requestParameters: AgentLoginOperationRequest,
   ...
   */
  async enableTotpRaw(
    requestParameters: EnableTotpRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
  ...
  /**
   */
  async getTotpSetupRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<TotpSetupResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TotpSetupResponseFromJSON(jsonValue),
    );
  }
  ...
  async registerRaw(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: RegistrationRequestToJSON(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RegistrationResponseFromJSON(jsonValue),
    );
  }
   ...
   */
  async userLoginRaw(
    requestParameters: UserLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<LoginResponse>> {
  ...
  /**
   */
  async userLoginWith2faRaw(
    requestParameters: UserLoginWith2faRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<LoginResponse>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: TwoFactorLoginRequestToJSON(
          requestParameters["twoFactorLoginRequest"],
        ),
      },
      initOverrides,
    );
  ...
  async userLoginWith2fa(
    ...
    const response = await this.userLoginWith2faRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
