...
- **Trademark Restrictions:** You **cannot** use the name "Bitwarden" or their logos in your product name or marketing. Using "Bitwarden-compatible" in technical descriptions is generally acceptable, but the product must have a distinct brand (e.g., _AgentPassVault_ instead of _Agent-Bitwarden_).
...
- **Usage:** While GPL allows creating third-party clients/servers, any code _derived_ from GPL code must also be GPL.
