...
public class KeyManagementService {
  ...
  public KeyManagementService(
      MasterKeyProvider masterKeyProvider, EncryptionService encryptionService) {
    if (masterKeyProvider == null) {
      throw new IllegalStateException("MasterKeyProvider cannot be null in KeyManagementService");
    }
    if (encryptionService == null) {
      throw new IllegalStateException("EncryptionService cannot be null in KeyManagementService");
    }
