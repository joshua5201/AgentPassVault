...
class RegistrationControllerTest extends BaseIntegrationTest {
  ...
  void register_NewTenantAndUser_Success() throws Exception {
    ...
    RegistrationRequest request =
        new RegistrationRequest("admin@example.com", "securePassword123", "Admin User");
  ...
  void register_MultipleUsersSameDefaultTenantName_Success() throws Exception {
    ...
    RegistrationRequest request1 =
        new RegistrationRequest("user1@example.com", "password", "User One");
    ...
    RegistrationRequest request2 =
        new RegistrationRequest("user2@example.com", "password", "User Two");
